...
/////////////////////////////////////////////////////////////////////////////
// proj27: cortical_feedback_ventral -> cortical_feedback_ventral with target inh
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct27 : LILMatrix<int, int> {
    ProjStruct27() : LILMatrix<int, int>( 6, 6) {
    }
    ...
    void compute_psp() {
        ...
        if (_transmission && pop10._active) {
            int _s, _stop;
            double _tmp_sum[4];
            double* __restrict__ _pre_r = pop10.r.data();
