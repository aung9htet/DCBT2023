...
/////////////////////////////////////////////////////////////////////////////
// proj83: thalamus_dorsolateral -> premotor with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct83 : LILMatrix<int, int> {
    ProjStruct83() : LILMatrix<int, int>( 3, 3) {
    }
    ...
    #ifdef __AVX__
        if (_transmission && pop29._active) {
            int _s, _stop;
            double _tmp_sum[4];
            double* __restrict__ _pre_r = pop28.r.data();
