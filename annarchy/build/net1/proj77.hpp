...
/////////////////////////////////////////////////////////////////////////////
// proj77: striatum_d1_dorsolateral -> gpi_dorsolateral with target inh
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct77 : LILMatrix<int, int> {
    ProjStruct77() : LILMatrix<int, int>( 3, 6) {
    }
    ...
    #ifdef __AVX__
        if (_transmission && pop27._active) {
            int _s, _stop;
            double _tmp_sum[4];
            double* __restrict__ _pre_r = pop26.r.data();
