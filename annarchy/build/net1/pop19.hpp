...
///////////////////////////////////////////////////////////////
// Main Structure for the population of id 19 (gpi_dorsomedial)
///////////////////////////////////////////////////////////////
struct PopStruct19{
...
std::vector<double> rand_0 ;
    ...
    #ifdef _DEBUG
        std::cout << "PopStruct19::init_population(size="<<this->size<<") - this = " << this << std::endl;
    #endif
        _active = true;
...
rand_0[i] = dist_rand_0(rng[0]);
    ...
    void update() {
        ...
        if( _active ) {
        #ifdef _TRACE_SIMULATION_STEPS
            std::cout << "    PopStruct19::update()" << std::endl;
        #endif
