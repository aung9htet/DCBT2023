...
/////////////////////////////////////////////////////////////////////////////
// proj34: nacc_core -> substantia_nigra_pars_reticulata with target inh
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct34 : LILMatrix<int, int> {
    ProjStruct34() : LILMatrix<int, int>( 6, 6) {
    }
    ...
    void compute_psp() {
        ...
        if (_transmission && pop14._active) {
            int _s, _stop;
            double _tmp_sum[4];
            double* __restrict__ _pre_r = pop13.r.data();
