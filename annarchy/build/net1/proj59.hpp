...
/////////////////////////////////////////////////////////////////////////////
// proj59: pptn_dorsomedial -> substantia_nigra_pars_compacta with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct59 : LILMatrix<int, int> {
    ProjStruct59() : LILMatrix<int, int>( 6, 6) {
    }
    ...
    void compute_psp() {
        ...
        if (_transmission && pop21._active) {
            int _s, _stop;
            double _tmp_sum[4];
            double* __restrict__ _pre_r = pop22.r.data();
