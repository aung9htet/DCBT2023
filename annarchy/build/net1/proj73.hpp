...
/////////////////////////////////////////////////////////////////////////////
// proj73: cortical_feedback_dorsomedial -> gpi_dorsomedial with target inh
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct73 : LILMatrix<int, int> {
    ProjStruct73() : LILMatrix<int, int>( 6, 6) {
    }
    ...
    void compute_psp() {
        ...
        if (_transmission && pop19._active) {
            int _s, _stop;
            double _tmp_sum[4];
            double* __restrict__ _pre_r = pop23.r.data();
