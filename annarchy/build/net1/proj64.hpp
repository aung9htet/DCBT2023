...
/////////////////////////////////////////////////////////////////////////////
// proj64: substantia_nigra_pars_compacta -> stn_dorsomedial with target dopa
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct64 : LILMatrix<int, int> {
    ProjStruct64() : LILMatrix<int, int>( 3, 6) {
    }
    ...
    #ifdef __AVX__
        if (_transmission && pop18._active) {
            int _s, _stop;
            double _tmp_sum[4];
            double* __restrict__ _pre_r = pop21.r.data();
            ...
            for (int i = 0; i < post_rank.size(); i++) {
                ...
                pop18._sum_dopa[rk_post] += w * lsum;
            }
        } // active
    #else
