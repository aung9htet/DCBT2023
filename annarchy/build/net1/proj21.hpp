...
/////////////////////////////////////////////////////////////////////////////
// proj21: pptn_ventral -> ventral_tegmental_area with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct21 : LILMatrix<int, int> {
    ProjStruct21() : LILMatrix<int, int>( 1, 1) {
    }
    ...
    void compute_psp() {
        ...
        if (_transmission && pop8._active) {
            int _s, _stop;
            double _tmp_sum[4];
            double* __restrict__ _pre_r = pop9.r.data();
