...
/////////////////////////////////////////////////////////////////////////////
// proj6: vp_direct -> vp_direct with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct6 : LILMatrix<int, int> {
    ProjStruct6() : LILMatrix<int, int>( 6, 6) {
    }
    ...
    #ifdef _DEBUG
        std::cout << "ProjStruct6::get_local_attribute_row_double(name = "<<name<<", rk_post = "<<rk_post<<", rk_pre = "<<rk_pre<<")" << std::endl;
    #endif
