...
///////////////////////////////////////////////////////////////
// Main Structure for the population of id 28 (thalamus_dorsolateral)
///////////////////////////////////////////////////////////////
struct PopStruct28{
...
std::vector<double> rand_0 ;
    ...
    std::vector<double> get_local_attribute_all_double(std::string name) {
        ...
        // should not happen
        std::cerr << "PopStruct28::get_local_attribute_all_double: " << name << " not found" << std::endl;
    ...
    double get_local_attribute_double(std::string name, int rk) {
        ...
        // should not happen
        std::cerr << "PopStruct28::get_local_attribute_double: " << name << " not found" << std::endl;
    ...
    void set_local_attribute_all_double(std::string name, std::vector<double> value) {
        ...
        // should not happen
        std::cerr << "PopStruct28::set_local_attribute_all_double: " << name << " not found" << std::endl;
    }
    ...
    void set_local_attribute_double(std::string name, int rk, double value) {
        ...
        // should not happen
        std::cerr << "PopStruct28::set_local_attribute_double: " << name << " not found" << std::endl;
    }
    ...
    #ifdef _DEBUG
        std::cout << "PopStruct28::init_population(size="<<this->size<<") - this = " << this << std::endl;
    #endif
        _active = true;
    ...
    std::cout << "    PopStruct28::update_rng()" << std::endl;
#endif
...
rand_0[i] = dist_rand_0(rng[0]);
    ...
    void update() {
        ...
        if( _active ) {
        #ifdef _TRACE_SIMULATION_STEPS
            std::cout << "    PopStruct28::update()" << std::endl;
        #endif
    ...
    void clear() {
#ifdef _DEBUG
    std::cout << "PopStruct28::clear() - this = " << this << std::endl;
#endif
        // Variables
        mp.clear();
        mp.shrink_to_fit();
