...
/////////////////////////////////////////////////////////////////////////////
// proj67: dorsolateral_pfc -> cortical_feedback_dorsomedial with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct67 : LILMatrix<int, int> {
    ProjStruct67() : LILMatrix<int, int>( 6, 6) {
    }
    ...
    void compute_psp() {
        ...
        if (_transmission && pop23._active) {
            int _s, _stop;
            double _tmp_sum[4];
            double* __restrict__ _pre_r = pop25.r.data();
