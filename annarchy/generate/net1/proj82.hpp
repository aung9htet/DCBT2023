...
/////////////////////////////////////////////////////////////////////////////
// proj82: gpi_dorsolateral -> thalamus_dorsolateral with target inh
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct82 : LILMatrix<int, int> {
    ProjStruct82() : LILMatrix<int, int>( 3, 3) {
    }
    ...
    #ifdef __AVX__
        if (_transmission && pop28._active) {
            int _s, _stop;
            double _tmp_sum[4];
            double* __restrict__ _pre_r = pop27.r.data();
