...
/////////////////////////////////////////////////////////////////////////////
// proj54: visual_input -> stn_dorsomedial with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct54 : LILMatrix<int, int> {
    ProjStruct54() : LILMatrix<int, int>( 3, 12) {
    }
    ...
    void compute_psp() {
        ...
        if (_transmission && pop18._active) {
            int _s, _stop;
            double _tmp_sum[4];
            double* __restrict__ _pre_r = pop15.r.data();
