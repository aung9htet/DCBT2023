...
/////////////////////////////////////////////////////////////////////////////
// proj5: vp_direct -> vp_direct with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct5 : LILMatrix<int, int> {
    ProjStruct5() : LILMatrix<int, int>( 6, 6) {
    }
    ...
    #ifdef _DEBUG
        std::cout << "ProjStruct5::get_local_attribute_row_double(name = "<<name<<", rk_post = "<<rk_post<<", rk_pre = "<<rk_pre<<")" << std::endl;
    #endif
