...
/////////////////////////////////////////////////////////////////////////////
// proj39: gpi_dorsomedial -> gpi_dorsomedial with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct39 : LILMatrix<int, int> {
    ProjStruct39() : LILMatrix<int, int>( 6, 6) {
    }
        ...
        if (_transmission && pop19._active) {
            ...
            for (int i = 0; i < post_rank.size(); i++) {
                ...
                for (int j = 0; j < pre_rank[i].size(); j++) {
                    sum +=  w*positive(-pop19.r[pre_rank[i][j]] + reversal[i][j]) ;
                }
                pop19._sum_exc[post_rank[i]] += sum;
            }
    ...
    #ifdef _DEBUG
        std::cout << "ProjStruct39::get_local_attribute_all_double(name = "<<name<<")" << std::endl;
    #endif
    ...
    #ifdef _DEBUG
        std::cout << "ProjStruct39::get_local_attribute_row_double(name = "<<name<<", rk_post = "<<rk_post<<")" << std::endl;
    #endif
    ...
    #ifdef _DEBUG
        std::cout << "ProjStruct39::get_local_attribute_row_double(name = "<<name<<", rk_post = "<<rk_post<<", rk_pre = "<<rk_pre<<")" << std::endl;
    #endif
