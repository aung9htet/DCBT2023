...
/////////////////////////////////////////////////////////////////////////////
// proj35: substantia_nigra_pars_reticulata -> thalamus_ventral with target inh
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct35 : LILMatrix<int, int> {
    ProjStruct35() : LILMatrix<int, int>( 6, 6) {
    }
    ...
    void compute_psp() {
        ...
        if (_transmission && pop11._active) {
            int _s, _stop;
            double _tmp_sum[4];
            double* __restrict__ _pre_r = pop14.r.data();
