...
/////////////////////////////////////////////////////////////////////////////
// proj58: stn_dorsomedial -> gpi_dorsomedial with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct58 : LILMatrix<int, int> {
    ProjStruct58() : LILMatrix<int, int>( 6, 3) {
    }
    ...
    void compute_psp() {
        ...
        if (_transmission && pop19._active) {
            int _s, _stop;
            double _tmp_sum[4];
            double* __restrict__ _pre_r = pop18.r.data();
