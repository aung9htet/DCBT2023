...
/////////////////////////////////////////////////////////////////////////////
// proj45: thalamus_dorsomedial -> thalamus_dorsomedial with target inh
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct45 : LILMatrix<int, int> {
    ProjStruct45() : LILMatrix<int, int>( 6, 6) {
    }
    ...
    void compute_psp() {
        ...
        if (_transmission && pop24._active) {
            int _s, _stop;
            double _tmp_sum[4];
            double* __restrict__ _pre_r = pop24.r.data();
