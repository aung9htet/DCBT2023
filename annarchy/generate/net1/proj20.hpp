...
/////////////////////////////////////////////////////////////////////////////
// proj20: ventral_tegmental_area -> reward_prediction_error with target dopa
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct20 : LILMatrix<int, int> {
    ProjStruct20() : LILMatrix<int, int>( 24, 1) {
    }
    ...
    void compute_psp() {
        ...
        if (_transmission && pop2._active) {
            int _s, _stop;
            double _tmp_sum[4];
            double* __restrict__ _pre_r = pop8.r.data();
